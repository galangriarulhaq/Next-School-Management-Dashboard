        ...
        <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <FormModal
                  ...
                  data={{
                    id: 1,
                    name: "Galang Riarulhaq",
                    username: "galangriaruhaq",
                    email: "galangriaruhaq@gmail",
                    password: "password",
                    firstName: "Galang",
                    lastName: "Riarulhaq",
          ...
          <div className="flex flex-1 gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                <h1 className="text-xl font-semibold">6D</h1>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-xs text-gray-400">
            <Link className="p-3 rounded-md bg-sYellowLight " href={`/list/lessons?classId=${2}`}>
              Student&apos;s Lessons
            </Link>
            <Link className="p-3 rounded-md bg-sPurpleLight " href={`/list/teachers?classId=${2}`}>
              Student&apos;s Teachers
            </Link>
            <Link className="p-3 rounded-md bg-pink-50 " href={`/list/exams?classId=${2}`}>
              Student&apos;s Exams
            </Link>
            <Link className="p-3 rounded-md bg-sSkyLight " href={`/list/assignments?classId=${2}`}>
              Student&apos;s Assigments
            </Link>
            <Link className="p-3 rounded-md bg-sSkyLight" href={`/list/results?studentId=${"student2"}`}>
              Student&apos;s Results
            </Link>
          </div>
        </div>
